...
%random_test_samples = rand(10,1) * 50 + 100;
%writematrix(random_test_samples, 'random_test_samples_100_150.txt');
...
all_x = [ x_100' x_110' x_120' x_130' x_140' x_150'  ];
%all_x = [ x_120'  x_140' ];
...
all_y = [ y_100' y_110' y_120' y_130' y_140' y_150' ];
%all_y = [ y_120'  y_140' ];
